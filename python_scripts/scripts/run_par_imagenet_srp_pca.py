...
from image_processing.feature_extraction import srp_pca_imagenet_wrapper
...
# e.g. to call it:
# mpiexec -np 4 run_par_imagenet_srp_pca.py --model_name='alexnet' --pkg=torchvision --pooling=all --n_srp_components=1000 --n_pca_components=10 --batch_size=100 --img_size=224

parser = argparse.ArgumentParser(
    description="Fit and save ImageNet validation SRP-to-PCA components for an imgANN model."
)
...
master_workers_queue(task_list, paths, srp_pca_imagenet_wrapper, *(ann, loader, cfg.n_srp_components, cfg.n_pca_components), **{"device": device}) 
